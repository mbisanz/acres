...
public class ReservationServiceBean implements ReservationService {
	...
	@Override
	public List<Reservation> findReservations(String login, String aircraftRegistration, List<ReservationState> states) {
		User user = null;
		if (login != null) {
	...
	private void validate(Reservation reservation) {
		if (reservation.getValidFrom() == null) {
			throw new AcresValidationException("Start date is required");
		}
		if (reservation.getValidTo() == null) {
			throw new AcresValidationException("End date is required");
		}
